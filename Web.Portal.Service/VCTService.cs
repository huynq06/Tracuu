        ...
        public IEnumerable<VCT> GetAllToday(int id)
        {
            ...
            if (result > 0)
            {
                if (id == 0)
                    ...
                    return _vctRepository.GetMulti(c => c.LABS_CREATED_AT.Value.Day == DateTime.Now.Day  && c.LABS_CREATED_AT.Value.Month == DateTime.Now.Month && c.LABS_CREATED_AT.Value.Year == DateTime.Now.Year && c.AWB_STATUS == 2 && c.LOCATION == 1).OrderBy(c => c.LABS_PROCESS_AT);
                else
                    return _vctRepository.GetMulti(c => c.LABS_CREATED_AT.Value.Day == DateTime.Now.Day  && c.LABS_CREATED_AT.Value.Month == DateTime.Now.Month && c.LABS_CREATED_AT.Value.Year == DateTime.Now.Year && c.AWB_STATUS == 2 && c.LOCATION == 2).OrderBy(c => c.LABS_PROCESS_AT);
            }
            else
            {
                if (id == 0)
                    ...
                    return _vctRepository.GetMulti(c => (c.LABS_CREATED_AT.Value.Day == DateTime.Now.Day || c.LABS_CREATED_AT.Value.Day == DateTime.Now.Day - 1) && c.LABS_CREATED_AT.Value.Month == DateTime.Now.Month && c.LABS_CREATED_AT.Value.Year == DateTime.Now.Year && c.AWB_STATUS == 2 && c.LOCATION == 1).OrderBy(c => c.LABS_PROCESS_AT);
                else
                    return _vctRepository.GetMulti(c => (c.LABS_CREATED_AT.Value.Day == DateTime.Now.Day || c.LABS_CREATED_AT.Value.Day == DateTime.Now.Day - 1) && c.LABS_CREATED_AT.Value.Month == DateTime.Now.Month && c.LABS_CREATED_AT.Value.Year == DateTime.Now.Year && c.AWB_STATUS == 2 && c.LOCATION == 2).OrderBy(c => c.LABS_PROCESS_AT);
            }
