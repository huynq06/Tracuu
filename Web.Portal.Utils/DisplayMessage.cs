...
namespace Web.Portal.Utils
{
    ...
    {
        public const string MessageSucces = "<div class='alert alert-success'><strong><i class='fa fa-check'></i> {0}</strong></div>";
        public const string MessageWarning = "<div class='alert alert-warning'><strong><i class='fa fa-exclamation-triangle'></i> {0}</strong></div>";
        public const string MessageError = "<div class='alert alert-danger'><strong><i class='fa fa-times'></i> {0}</strong></div>";
        ...
        public const int ACTION_NEW = 1;
        public const int ACTION_UPDATE = 2;
        public const int ACTION_DELETE = 3;

        public const int PageSize = 20;

        public static string SetMessage(int Action)
        {
            switch (Action)
            {
                case ACTION_UPDATE:
