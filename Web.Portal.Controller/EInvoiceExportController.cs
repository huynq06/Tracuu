...
namespace Web.Portal.Controller
{
    ...
    public class EInvoiceExportController : BaseController
    {
        ...
        public EInvoiceExportController(IHermesInvoiceService iHermesInvoiceService,
        ...
        public void ShowData(bool export)
        {
            ...
            if (export)
            {
                Invoices = _iHermesInvoiceService.GetListPaging(dateCheck.Value, no, awb, hawb, staff, status, page,
                                                                                  pageSize,
                                                                                  ref total, "EXPORT AWB", ref totalRecord, ref totalHermes).OrderBy(c => c.Sequence).ToList();
            }
            else
            {
                Invoices = _iHermesInvoiceService.GetListPaging(dateCheck.Value, no, awb, hawb, staff, status, page,
                                                                                 pageSize,
                                                                                 ref total, "EXPORT AWB", ref totalRecord);
            }
        ...
        public ActionResult SaveReplace(string order)
        {
            ...
            try
            {
                ...
                string jsonResult = JsonCreateInvoiceALSC(invoiceDB);
                string rp = "";
        ...
        public string JsonCreateInvoiceALSC(HermesInvoice invoice)
        {
            string jsonResult = "";
