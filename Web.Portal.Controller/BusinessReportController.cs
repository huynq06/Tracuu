...
namespace Web.Portal.Controller
{
    ...
    public class BusinessReportController : BaseController
    {
        ...
        public ActionResult Report()
        {
            ...
            ViewBag.SHC = shc;
            ViewBag.Mawb = mawb;
            return View("~/Views/BusinessReport/DailyExport.cshtml");
        }
        ...
        public ActionResult ReportList()
        {
            ...
            Utils.SQLUtils.GetSQLDes(Server.MapPath("/SitaTemplate/SQLKD.xml"), id, ref sql, ref find, ref column, ref des);
            ...
            if(id== "HERMES04")
            {
                return View("~/Views/BusinessReport/VCTReportList.cshtml");
            }
            return View();
        }
        [DocumentExport("EXCEL", "KD_")]
        public ActionResult Export()
        {
            ...
            if (id == "HERMES04")
            {
                return View("~/Views/BusinessReport/VCTExpReport.cshtml");
            }
            return View("~/Views/BusinessReport/ExpReport.cshtml");
        }
    }
}
