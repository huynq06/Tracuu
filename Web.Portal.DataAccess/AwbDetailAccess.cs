...
namespace Web.Portal.DataAccess
{
    public class AwbDetailAccess : DataBase.OracleProvider
    {
        ...
        private AwbDetailViewModel GetProperties(OracleDataReader reader)
        {
            ...
            awb.Pieces_Received = Convert.ToInt32(GetValueField(reader, "PIECES_RECEIVED", string.Empty));
            awb.Pieces_Expected = Convert.ToInt32(GetValueField(reader, "PIECES_EXPECTED", string.Empty));
